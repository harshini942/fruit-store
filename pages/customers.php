...
if(isset($_POST['edit_customer'])) {
    ...
    mysqli_query($conn, "UPDATE customers SET name='$name', phone='$phone', email='$email', address='$address' WHERE id=$id");
    header("Location: customers.php");
    exit();
}
...
<html>
<head>
    <title>Customers - Fruit Store</title>
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <br>
            <button class="btn btn-add" onclick="showAddModal()"><i class="fas fa-plus"></i> Add New Customer</button>
            <br><br>
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="modal-buttons">
                    <button type="submit" name="add_customer" class="btn btn-add"><i class="fas fa-save"></i> Save</button>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="modal-buttons">
                    <button type="submit" name="edit_customer" class="btn btn-add"><i class="fas fa-save"></i> Update</button>
